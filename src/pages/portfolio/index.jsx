...
import { contactUsData, educationData, skillsData } from "../../constants/index";
import {
    cardStyles,
        ...
        return (
            <>
                <Box sx={mySelfContainerStyles}>
                    <img src={mySelfImg} alt="mySelfImg"  style={{width:"150px", height:"150px"}} className={styles.mySelfImageStyles}/>
                        ...
                        return (
                            <Accordion
                                ...
                                <AccordionSummary
                                    ...
                                    <img src={item?.icon} alt="item?.icon" style={{width:"40px", height:"40px"}} className={styles.educationImgStyles} />
                    ...
                    {skillsData?.map((item, index) => {
                        return (
                            <Card key={index} sx={cardStyles}>
                                <CardActionArea>
                                    <CardContent>
                                        <img src={item?.image} style={{width:"100px", height:"100px", objectFit:"contain"}} alt={item?.title} className={styles.imageStyles}/>
